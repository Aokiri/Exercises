// Link to the exercise: https://exercism.org/tracks/csharp/exercises/beauty-salon-goes-global
...
public static class Appointment
{
    ...
    {
        TimeZoneInfo timeZoneInfo = GetTimeZoneInfo(location);
        DateTime sevenDaysEarlier = dateTime.AddDays(-7);
    ...
    {
        CultureInfo cultureInfo = GetLocationCultureInfo(location);
        bool isSuccess = DateTime.TryParse(dataTimeText, cultureInfo, DateTimeStyles.None, out var dateTime);
